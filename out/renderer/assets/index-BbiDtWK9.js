...
const useLLMStore = create((set, get) => ({
  ...
  fetchProviders: async () => {
    ...
    try {
      ...
      const active2 = providers.find((p) => p.is_active === 1) || null;
      set({ providers, activeProvider: active2, isLoading: false });
    } catch (err) {
...
const useSessionStore = create((set, get) => ({
  ...
  createSession: async (projectId, name, parentSessionId, summary) => {
    try {
...
"""`
        ...
        cleanup = window.electronAPI.llm.onChunk(assistantMsgId, async (_event, data) => {
          if (data.type === "chunk" && data.text) {
            ...
            set((state) => ({
              messages: state.messages.map(
                (m) => m.id === assistantMsgId ? { ...m, content: accumulatedContent } : m
              )
            }));
            return;
          }
          if (data.type === "done") {
            ...
            try {
              ...
              set((state) => ({
                messages: state.messages.map(
                  (m) => m.id === assistantMsgId ? { ...m, tokens: assistantTokens } : m
                ),
                isStreaming: false,
                streamingMessageId: null
              }));
  ...
  checkContextThreshold: async (projectId) => {
...
function ProjectFolder({ project, isActive }) {
  ...
  const loadSessions = reactExports.useCallback(async () => {
    try {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0 flex-1", children: [
            ...
            project.isGit ? /* @__PURE__ */ jsxRuntimeExports.jsx(FolderGit2, { className: `w-4 h-4 shrink-0 transition-colors ${isActive ? "text-[var(--color-text-primary)]" : "text-[var(--color-text-muted)] group-hover:text-[var(--color-text-secondary)]"}` }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Folder, { className: `w-4 h-4 shrink-0 transition-colors ${isActive ? "text-[var(--color-text-primary)]" : "text-[var(--color-text-muted)] group-hover:text-[var(--color-text-secondary)]"}` }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs truncate flex-1 leading-none", children: project.name })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center opacity-0 group-hover:opacity-100 transition-opacity gap-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `folder-sessions-collapse ${expanded ? "expanded" : ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "folder-sessions-inner pl-6 flex flex-col gap-0.5 border-l border-[var(--color-border)]/50 ml-5", children: [
      sessions.map((session) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `
                ...
                ${activeSessionId === session.id ? "bg-[var(--color-bg-active)] border-[var(--color-border)] text-[var(--color-text-primary)] font-medium shadow-sm" : "bg-transparent border-transparent hover:bg-[var(--color-bg-hover)] text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)]"}
              `,
          onClick: () => {
            setCurrentProject(project.id);
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0 flex-1", children: [
              session.parent_session_id ? /* @__PURE__ */ jsxRuntimeExports.jsx(GitFork, { className: "w-3.5 h-3.5 text-[var(--color-text-secondary)] shrink-0" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { className: "w-3.5 h-3.5 text-[var(--color-text-muted)] shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs truncate flex-1 leading-none", children: session.name })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
      ...
      sessions.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-1.5 text-[11px] text-[var(--color-text-muted)] select-none italic", children: "无对话" })
    ] }) })
  ] });
}
function ProjectTree() {
  ...
  const [listExpanded, setListExpanded] = reactExports.useState(true);
  reactExports.useEffect(() => {
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[var(--color-text-muted)] text-sm", children: "加载中..." }) });
  }
  if (projects.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[var(--color-text-muted)] text-sm", children: "暂无项目" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[var(--color-text-muted)] text-xs mt-1", children: "创建项目后显示在这里" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-4 h-4 inline mr-1" }),
            "创建项目"
          ]
        }
      )
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-3 py-1 mb-1 text-[var(--color-text-secondary)] font-medium select-none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", children: "项目列表" }),
            listExpanded ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-3 h-3 text-[var(--color-text-muted)]" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-3 h-3 text-[var(--color-text-muted)]" })
          ]
        }
      ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `folder-sessions-collapse ${listExpanded ? "expanded" : ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "folder-sessions-inner space-y-2", children: projects.map((project) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      ProjectFolder,
      {
        project,
...
function ThemeToggle() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      title: current.label,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(current.icon, { className: "w-4 h-4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: current.label })
      ]
    }
  );
}
    ...
    "aside",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.sidebarTop, children: isSettings ? /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: onExitSettings, className: styles.backBtn, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: handleNewChat, className: styles.sidebarMenuBtn, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SquarePen, { className: "w-4 h-4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "新对话" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.sidebarMenuSearch, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "w-4 h-4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", placeholder: "搜索" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: styles.sidebarMenuBtn, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutGrid, { className: "w-4 h-4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "插件" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: styles.sidebarMenuBtn, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(GitFork, { className: "w-4 h-4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "工作流" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
        ...
        !isSettings ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-2 py-2 flex flex-col gap-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProjectTree, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.bottomBar, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeToggle, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onOpenSettings, title: "模型配置", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { className: "w-4 h-4" }) })
          ] })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.settingsMenu, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.settingsMenuHeader, children: "通用设置" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${styles.settingsMenuItem} ${styles.active}`, children: [
...
function ChatArea({
  ...
  const [welcomeModelSelectorOpen, setWelcomeModelSelectorOpen] = reactExports.useState(false);
  const [composerModelSelectorOpen, setComposerModelSelectorOpen] = reactExports.useState(false);
  ...
  const currentProjectName = reactExports.useMemo(() => {
  ...
  const handleWelcomeSend = async (e) => {
  ...
  const handleSelectModel = async (providerId, modelName) => {
  ...
  const renderMessageContent = (content) => {
    ...
    const renderThink = () => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 border-l-2 border-[var(--color-accent)]/30 bg-black/5 dark:bg-white/5 rounded-r-md px-3.5 py-2 text-xs text-[var(--color-text-secondary)] italic select-text", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-[var(--color-accent)] font-semibold not-italic mb-1.5 select-none text-[11px] uppercase tracking-wider", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: `w-3.5 h-3.5 ${!isFinished ? "animate-pulse" : ""}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: isFinished ? "深度思考已完成" : "正在思考中..." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "whitespace-pre-wrap leading-relaxed", children: thinkContent })
      ] });
    };
    const renderMain = (text) => {
      ...
      return parts.map((part, index) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "whitespace-pre-wrap leading-relaxed select-text text-sm", children: trimmed }, index);
      });
    };
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 flex flex-col items-center justify-center p-6 relative bg-[var(--bg-app)] overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[640px] w-full flex flex-col items-center gap-6 z-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "center-headline", children: [
          "现在让它们",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "动起来" }),
          "？"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "center-subline", children: currentProjectId ? `项目已加载：${currentProjectName} · 请输入以开启对话` : "选择左侧的项目或开始一个新对话，CDF 已经准备就绪" }),
        error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full p-3 rounded-lg bg-[var(--color-danger-dim)] text-[var(--color-danger)] text-xs flex items-center justify-between border border-[var(--color-danger)]/20 animate-fade-in shadow-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 font-medium", children: error }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: clearError,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dialog-box", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "textarea",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dialog-bottom", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dialog-bottom-left", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "dialog-btn", title: "添加附件", "aria-label": "添加附件", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Paperclip, { className: "w-4 h-4" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "model-selector-label", children: activeProvider ? `${activeProvider.name} • ${activeProvider.default_model}` : "选择模型" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "model-chevron w-3.5 h-3.5" })
                        ]
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "model-dropdown", children: providers.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        onClick: () => {
                          setWelcomeModelSelectorOpen(false);
                        ...
                        children: "暂无可用提供商，点击去配置"
                      }
                    ) : providers.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "model-group", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "model-group-name", children: p.name }),
                      getProviderModels(p).map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          className: `model-select-option ${activeProvider?.id === p.id && activeProvider?.default_model === m ? "selected" : ""}`,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                title: "发送",
                "aria-label": "发送消息",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUp, { className: "w-4.5 h-4.5" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sr-only", children: "发送消息" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "feature-rows", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "feature-card", onClick: handleCreateProject, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "feature-card-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-4 h-4" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "feature-card-title", children: "创建项目" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "feature-card-desc", children: "导入代码仓库或新建空白项目" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "feature-card", onClick: () => onOpenSettings?.(), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "feature-card-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SlidersVertical, { className: "w-4 h-4" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "feature-card-title", children: "配置 Skills" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "feature-card-desc", children: "安装和启用智能体能力模块" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "feature-card", onClick: () => onOpenSettings?.(), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "feature-card-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { className: "w-4 h-4" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "feature-card-title", children: "连接 MCP" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "feature-card-desc", children: "配置数据源和外部工具集成" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dialog-footer", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "dialog-footer-hint", children: [
          "按下 ",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col h-full bg-[var(--color-bg-app)] overflow-hidden relative", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 relative overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "messages absolute inset-0 overflow-y-auto", style: { paddingBottom: "180px" }, children: [
      activeSession?.summary && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 p-4 rounded-xl border border-[var(--color-accent)]/20 bg-gradient-to-br from-[var(--color-accent-dim)] to-transparent relative overflow-hidden flex flex-col gap-2 shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs text-[var(--color-accent)] font-semibold", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(GitFork, { className: "w-3.5 h-3.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "前序会话级联摘要" })
          ] }),
          activeSession.parent_session_id && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "回溯父会话历史" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-3.5 h-3.5" })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-[var(--color-text-secondary)] leading-relaxed italic border-l-2 border-[var(--color-accent)]/30 pl-3", children: [
          '"',
          activeSession.summary,
          '"'
        ] })
      ...
      messages.map((message) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "message-bubble", children: [
            renderMessageContent(message.content),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "message-time", children: [
      ...
      isStreaming && messages.length > 0 && messages[messages.length - 1].content === "" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "message assistant animate-pulse", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "message-bubble", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 py-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-[var(--color-text-muted)] animate-bounce", style: { animationDelay: "0ms" } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-[var(--color-text-muted)] animate-bounce", style: { animationDelay: "150ms" } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-[var(--color-text-muted)] animate-bounce", style: { animationDelay: "300ms" } })
      ] }) }) }),
      error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-[var(--color-danger-dim)] border border-[var(--color-danger)]/20 rounded-xl flex items-start gap-2.5 text-xs text-[var(--color-danger)] shadow-sm animate-shake", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 px-6 pb-6 pt-12 bg-gradient-to-t from-[var(--color-bg-app)] via-[var(--color-bg-app)]/95 to-transparent z-10 pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSend, className: "max-w-[760px] mx-auto flex flex-col bg-[var(--color-bg-surface)] border border-[var(--color-border)] focus-within:border-[var(--color-accent)] focus-within:ring-1 focus-within:ring-[var(--color-accent)]/20 rounded-xl p-3 transition-all shadow-lg pointer-events-auto", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-t border-[var(--color-border)]/30 pt-2.5 mt-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1.5", children: activeProvider && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  className: "model-selector-trigger",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "model-selector-label truncate max-w-[150px]", children: [
                      activeProvider.name,
                      " • ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "model-dropdown", style: { left: 0, bottom: "calc(100% + 8px)" }, children: providers.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  onClick: () => {
                    setComposerModelSelectorOpen(false);
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: isStreaming ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
...
function TaskPanel({ isOpen, onClose, width, onResize }) {
  ...
  const statusIcon = (status) => {
    switch (status) {
      case "success":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "w-4 h-4 text-[var(--color-success)]" });
      case "failed":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { className: "w-4 h-4 text-[var(--color-danger)]" });
      case "running":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Loader, { className: "w-4 h-4 animate-spin text-[var(--color-accent)]" });
      default:
...
function ModelSettings() {
  ...
  const [formType, setFormType] = reactExports.useState("openai");
  const [formKey, setFormKey] = reactExports.useState("");
  const [formUrl, setFormUrl] = reactExports.useState("");
  const [formModel, setFormModel] = reactExports.useState("");
  const [formLimit, setFormLimit] = reactExports.useState(8192);
  const [formActive, setFormActive] = reactExports.useState(false);
  const [showKey, setShowKey] = reactExports.useState(false);
  const [ollamaModels, setOllamaModels] = reactExports.useState([]);
  const [fetchingOllama, setFetchingOllama] = reactExports.useState(false);
  const [ollamaError, setOllamaError] = reactExports.useState(null);
  const [testingId, setTestingId] = reactExports.useState(null);
  const [fetchingModelsId, setFetchingModelsId] = reactExports.useState(null);
  reactExports.useEffect(() => {
    fetchProviders();
  }, [fetchProviders]);
  ...
  const fetchModelsList = async (p) => {
    ...
    try {
      ...
      if (fetchedModels && fetchedModels.length > 0) {
        ...
        const combined = Array.from(/* @__PURE__ */ new Set([...existing, ...fetchedModels]));
  ...
  const handleAddModelInline = async (p, modelId) => {
  ...
  const handleRemoveModelInline = async (p, modelId) => {
    const existing = p.models || [];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col h-full bg-[var(--bg-app)] overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "main-topbar flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "topbar-title", children: "模型供应商配置" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "topbar-subtitle", children: "管理 API 密钥、接口端点和可用模型标签" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "topbar-actions flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn btn-primary flex items-center gap-1.5 no-drag", onClick: openCreateModal, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-4 h-4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "添加供应商" })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-content", children: [
      error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 p-3 bg-[var(--color-danger-dim)] border border-[var(--color-danger)]/20 rounded-lg flex items-start gap-2 text-xs text-[var(--color-danger)]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-4 h-4 shrink-0 mt-0.5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: error })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "provider-list", children: [
        providers.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "provider-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "provider-card-head", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "provider-meta", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "provider-icon", children: p.name ? p.name.charAt(0).toUpperCase() : "M" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "provider-name flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: p.name }),
                  p.is_active === 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-1.5 py-0.5 rounded text-xs bg-[var(--color-success-dim)] text-[var(--color-success)] font-semibold uppercase", children: "已激活" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "provider-type capitalize", children: [
                  p.provider_type,
                  " · ",
                  p.api_url || "官方 API 接口"
                ] })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "provider-actions", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  "aria-label": "测试接口连接",
                  children: [
                    testingId === p.id ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-3.5 h-3.5 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "w-3.5 h-3.5" }),
                    "测试"
                  ]
                }
              ),
              p.provider_type !== "anthropic" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  className: "btn btn-secondary btn-sm",
                  ...
                  title: "自动拉取可用模型列表",
                  children: [
                    fetchingModelsId === p.id ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-3.5 h-3.5 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "w-3.5 h-3.5" }),
                    "获取模型"
                  ]
                }
              ),
              p.is_active !== 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "provider-models", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "models-label", children: [
              "已配置模型标签（",
              p.models?.length || 0,
              "）"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "model-tags", children: [
              p.models && p.models.map((modelName) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `model-tag ${p.default_model === modelName ? "border-[var(--color-accent)] text-[var(--color-accent-hover)] font-medium bg-[var(--color-accent-dim)]" : ""}`, children: [
                modelName,
                p.default_model === modelName && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-[var(--color-accent-hover)]", children: "(默认)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
              ...
              (!p.models || p.models.length === 0) && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-[var(--color-text-muted)] italic", children: "暂未配置模型，可在下方手动输入或点击“获取模型”" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "add-model-row", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  id: `newModel-${p.id}`,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  className: "btn btn-secondary btn-sm",
                  onClick: () => {
                    const input = document.getElementById(`newModel-${p.id}`);
        ...
        providers.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-16 bg-[var(--color-bg-surface)] border border-[var(--color-border)] rounded-xl text-sm text-[var(--color-text-muted)]", children: "暂无配置好的模型供应商，点击右上角「添加供应商」按钮开始！" })
      ] })
    ] }),
    isModalOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-overlay visible", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "modal animate-fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center modal-title border-b border-[var(--color-border)] pb-3 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-base", children: editingProviderId ? `编辑供应商 · ${formName}` : "添加供应商" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSaveModal, className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "form-label", children: [
              "供应商名称 ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[var(--color-danger)]", children: "*" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", children: "服务类型" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                value: formType,
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "ollama", children: "Ollama (本地运行)" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "custom", children: "Custom (OpenAI 兼容)" })
                ]
              }
            )
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", children: "API Endpoint" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              className: "form-input",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "form-hint", children: "接口请求的基础 Base URL 地址，末尾不需要带斜杠" })
        ] }),
        formType !== "ollama" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "form-label", children: [
            "API Key ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[var(--color-danger)]", children: "*" })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", children: "默认模型名称" }),
            formType === "ollama" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  ...
                  children: fetchingOllama ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-3.5 h-3.5 animate-spin" }),
                    "获取中..."
                  ] }) : "获取本地模型列表"
                }
              ),
              ollamaError && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-[var(--color-danger)] self-center truncate max-w-[120px]", title: ollamaError, children: "拉取失败" })
            ] }),
            formType === "ollama" && ollamaModels.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              "select",
              {
                value: formModel,
                onChange: (e) => setFormModel(e.target.value),
                className: "form-input bg-[var(--color-bg-app)] border border-[var(--color-border)] focus:border-[var(--color-accent)] rounded-lg outline-none",
                children: ollamaModels.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: m, children: m }, m))
              }
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", children: "上下文限额 (Tokens)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "number",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 pt-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "modal_is_active", className: "text-xs font-semibold text-[var(--color-text-secondary)] select-none cursor-pointer", children: "将此提供商设为激活的模型（默认聊天使用）" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "modal-actions border-t border-[var(--color-border)] pt-4 mt-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "toast-container", children: toasts.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `toast ${t.type} flex items-center gap-2`, children: [
      t.type === "success" && /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "toast-icon text-[var(--color-success)] w-4 h-4", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", children: /* @__PURE__ */ jsxRuntimeExports.jsx("polyline", { points: "20 6 9 17 4 12" }) }),
      t.type === "error" && /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "toast-icon text-[var(--color-danger)] w-4 h-4", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "18", y1: "6", x2: "6", y2: "18" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "6", y1: "6", x2: "18", y2: "18" })
      ] }),
      t.type === "info" && /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "toast-icon text-[var(--color-info)] w-4 h-4", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-[var(--color-text-primary)]", children: t.message })
    ] }, t.id)) })
  ] });
}
function App() {
