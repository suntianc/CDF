...
<reference>
@/Users/suntc/project/CDF/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/suntc/project/CDF/.codex/get-shit-done/references/user-profiling.md` to load:
