...
- Usage: Reference from command with `@/Users/suntc/project/CDF/.codex/get-shit-done/workflows/{name}.md`
...
**commands/**
- Purpose: Slash commands installed to /Users/suntc/project/CDF/.codex/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
