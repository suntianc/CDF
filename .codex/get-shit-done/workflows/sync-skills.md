...
INSTALL_JS_GLOBAL="/Users/suntc/project/CDF/.codex/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/suntc/project/CDF/.codex/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
