...
```
Agent(
  prompt="Read /Users/suntc/project/CDF/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/suntc/project/CDF/.codex/get-shit-done/templates/VALIDATION.md`
