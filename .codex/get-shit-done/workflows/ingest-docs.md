...
```bash
INIT=$(node "/Users/suntc/project/CDF/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/suntc/project/CDF/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
