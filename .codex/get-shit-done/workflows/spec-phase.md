...
```bash
INIT=$(node "/Users/suntc/project/CDF/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/suntc/project/CDF/.codex/get-shit-done/templates/spec.md.
